...
static const EDITSTYLE Styles_Markdown[] = {
	...
	{ MULTI_STYLE(SCE_MARKDOWN_INDENTED_BLOCK, SCE_MARKDOWN_BACKTICK_BLOCK, SCE_MARKDOWN_TILDE_BLOCK, 0), NP2StyleX_CodeBlock, L"fore:#222222; back:#F4F4F4; eolfilled" },
	{ SCE_MARKDOWN_CODE_SPAN, NP2StyleX_InlineCode, L"fore:#222222; back:#F4F4F4" },
	{ MULTI_STYLE(SCE_MARKDOWN_DISPLAY_MATH, SCE_MARKDOWN_BACKTICK_MATH, SCE_MARKDOWN_TILDE_MATH, 0), NP2StyleX_DisplayMath, L"fore:#222222; back:#F4F4F4; eolfilled" },
	{ MULTI_STYLE(SCE_MARKDOWN_INLINE_MATH, SCE_MARKDOWN_INLINE_DISPLAY_MATH, SCE_MARKDOWN_MATH_SPAN, 0), NP2StyleX_InlineMath, L"fore:#222222; back:#F4F4F4" },
